...
public class Student implements Iterable<CourseReport>, Serializable {
    private String name;
    //the id is marked "transient" to make sure it doesn't transfer to the file
    ...
    public static class StudentIterator implements Iterator<CourseReport>, Serializable {
