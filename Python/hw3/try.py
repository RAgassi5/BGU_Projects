...
def preprocessing(text):
    """
    this function depends on the other functions I created, the function receives a string a returns a list consisting
    only from important words, based on our rules
...
def menu(corpus):
    ...
    while True:
        ...
        #print(menu_get_documents, menu_inverted_index)
        if choice == "1":
            ...
            while True:
                #doc_id_lst = sorted(list(get_scores_of_relevance_docs(processed_query, menu_inverted_index, menu_get_documents).keys())) #LIST OF SORTED KEYS OF SCORE RELEVANCE
                if query_choice == "A":
                    #print(score_dict)
            ...
            while True:
                if menu_get_documents.get(user_doc):
                    ...
                    #print(menu_inverted_index)
                    #print(menu_get_documents)
                    break




        elif choice == "3":  ##check: "playing"
            ...
            while True:
                ...
                if menu_get_documents.get(user_input_3) is None:
                    ...
                    if menu_inverted_index.get(processed_word_3) is None:
                        ...
                        ##user_word_3 = input(f'Insert a word:')
