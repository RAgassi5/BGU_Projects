...
public:
    //constructor
    Room(const std::string &RoomID, int fireCamp, const std::string &type_of_Monster, int monsterCurrentHealth, int monsterDamage);
   ...
   Monster *get_MonsterInDaRoom() const;
};
